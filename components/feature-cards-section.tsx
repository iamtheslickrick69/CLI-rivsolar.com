...
import { ChevronRight, Plus, Sun, Battery, DollarSign } from "lucide-react"

const featureCards = [
  {
    title: "Residential Solar Panels",
    description: "Tier-1 equipment, in-house crews",
    icon: Sun,
    illustration: (
  ...
  },
  {
    ...
    description: "Tesla Powerwall & Enphase",
    icon: Battery,
    illustration: (
      <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        <div className="flex gap-4">
          <div className="w-16 h-32 bg-gradient-to-b from-purple-500/30 to-purple-900/30 rounded-lg border border-purple-500/50 flex flex-col items-center justify-end p-2">
            <div className="w-full h-[80%] bg-purple-500/40 rounded" />
          </div>
          <div className="w-16 h-32 bg-gradient-to-b from-purple-500/30 to-purple-900/30 rounded-lg border border-purple-500/50 flex flex-col items-center justify-end p-2">
            <div className="w-full h-[60%] bg-purple-500/40 rounded" />
          </div>
          <div className="w-16 h-32 bg-gradient-to-b from-purple-500/30 to-purple-900/30 rounded-lg border border-purple-500/50 flex flex-col items-center justify-end p-2">
            <div className="w-full h-[90%] bg-purple-500/40 rounded" />
          </div>
        </div>
      </div>
    ),
  },
  {
    ...
    description: "$0 down, loan, lease, or cash",
    icon: DollarSign,
    illustration: (
      <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        <div className="text-center">
          <div className="text-5xl font-bold text-purple-400/60 mb-2">30%</div>
          <div className="text-zinc-500 text-sm">Federal Tax Credit</div>
          <div className="mt-4 flex gap-2 justify-center">
            <div className="px-3 py-1 bg-purple-500/20 rounded text-purple-400 text-xs">Loan</div>
            <div className="px-3 py-1 bg-purple-500/20 rounded text-purple-400 text-xs">Lease</div>
            <div className="px-3 py-1 bg-purple-500/20 rounded text-purple-400 text-xs">Cash</div>
          </div>
        </div>
      </div>
    ),
      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
            ...
            >
              Complete solar solutions for your home
            </motion.h2>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {featureCards.map((card, index) => (
              <motion.div
                ...
                className="bg-zinc-900/50 border border-zinc-800 hover:border-purple-500/50 transition-colors cursor-pointer group overflow-hidden relative flex flex-col justify-end"
                style={{
                  aspectRatio: "336 / 360",
                  borderRadius: "30px",
                  height: "360px",
              ...
              >
                ...
                >
                  ...
                  <div className="w-8 h-8 rounded-full border border-zinc-700 flex items-center justify-center text-zinc-500 group-hover:border-purple-500 group-hover:text-purple-400 transition-colors flex-shrink-0">
