...
export function AnimatedFolder({ title, projects, className, subtitle }: AnimatedFolderProps) {
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle at 50% 70%, #9333ea 0%, transparent 70%)",
        ...
        >
          {subtitle || `${projects.length} utilities supported`}
        </p>

        {/* Hover hint */}
        <div
          className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-1.5 text-xs text-zinc-500 transition-all duration-300"
          style={{
    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          "rounded-full bg-zinc-800/50 backdrop-blur-md",
      ...
      >
        <div
          className={cn("relative overflow-hidden", "rounded-2xl", "bg-zinc-900", "ring-1 ring-zinc-700", "shadow-2xl")}
          style={{
        ...
        >
          ...
          <div
            className={cn("px-6 py-5", "bg-zinc-900", "border-t border-zinc-800")}
            style={{
              opacity: animationPhase === "complete" && !isClosing ? 1 : 0,
