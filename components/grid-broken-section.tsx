...
const cardData = [
  {
    ...
    imgSrc: "https://pub-716deb83cd7742f6beb7fe0ea0cdebcb.r2.dev/glencanyon2.jpg",
  },
  {
    heading: "OUTDATED",
    ...
    imgSrc: "https://pub-716deb83cd7742f6beb7fe0ea0cdebcb.r2.dev/pexels-8335592-19170608.jpg",
  },
  {
    heading: "CONTROL",
    description: "Take control of your rate and start sending energy back to the grid—not drawing from it.",
    imgSrc: "https://pub-716deb83cd7742f6beb7fe0ea0cdebcb.r2.dev/IMG_7385.JPG",
  },
  {
    heading: "SAVE",
    description: "Not just today—but for your future, and your children's future.",
    imgSrc: "https://pub-716deb83cd7742f6beb7fe0ea0cdebcb.r2.dev/startsaving.jpg",
  },
]
